...
console.log(nome);
    ...
    document.getElementById('modal-prazo_aarrecadar').innerText =
        prazo_aarrecadar + ' dias';
...
function toggleCampanhas() {
    ...
    const dropdown =
        document.getElementById('campanhasDropdown');
...
function toggleExpandir(event) {
    ...
    const extra =
        document.getElementById('campanhasExtra');

    const icon =
        document.getElementById('icon-expand');
...
document.addEventListener('click', function(e) {
    ...
    const btn =
        document.querySelector('.btn-campanhas');
